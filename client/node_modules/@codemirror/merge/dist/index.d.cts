...
import { Text, ChangeDesc, EditorState, StateCommand, EditorStateConfig, StateField } from '@codemirror/state';
...
declare class Chunk {
    ...
    */
    static updateA(chunks: readonly Chunk[], a: Text, b: Text, changes: ChangeDesc): readonly Chunk[];
    /**
    Update a set of chunks for changes in document B.
    */
    static updateB(chunks: readonly Chunk[], a: Text, b: Text, changes: ChangeDesc): readonly Chunk[];
}
...
export { Change, Chunk, DiffConfig, DirectMergeConfig, MergeConfig, MergeView, acceptChunk, diff, getChunks, goToNextChunk, goToPreviousChunk, presentableDiff, rejectChunk, unifiedMergeView };
