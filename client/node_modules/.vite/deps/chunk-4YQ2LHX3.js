...
function resolveToSetextUnderline(events, context) {
  ...
  ok2(text3 !== void 0, "expected a `text` index to be found");
...
function initializeFactory(field) {
  ...
  function initializeText(effects) {
    ...
    function atBreak(code) {
      ...
      let index2 = -1;
      if (list2) {
        ok2(Array.isArray(list2), "expected `disable.null` to be populated");
        while (++index2 < list2.length) {
...
function createTokenizer(parser, initialize, from) {
  ...
  function consume(code) {
    ok2(code === expectedCode, "expected given code to equal expected code");
  ...
  function constructFactory(onreturn, fields) {
    ...
    function hook(constructs2, returnState, bogusState) {
      ...
      function ok3(code) {
        ok2(code === expectedCode, "expected code");
        consumed = true;
...
//# sourceMappingURL=chunk-4YQ2LHX3.js.map
